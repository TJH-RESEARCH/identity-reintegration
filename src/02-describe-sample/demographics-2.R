...
# Print -------------------------------------------------------------------
demographics_2 %>% print(n = 100)

# Save --------------------------------------------------------------------
demographics_2 %>% readr::write_csv(here::here('output/study-2/demographics-2.csv'))
